...
val read_fasta_sequence :
  (string -> string Stream.t -> fasta Stream.t) ->
  string -> string Stream.t -> fasta Stream.t
val extract_header : string -> string Stream.t -> string * string
val read_fasta_header : string -> string Stream.t -> fasta Stream.t
val read : string Stream.t -> fasta Stream.t
val read_file : ?chunk_size:int -> string -> fasta Stream.t
val to_seq : fasta Stream.t -> char Stream.t
